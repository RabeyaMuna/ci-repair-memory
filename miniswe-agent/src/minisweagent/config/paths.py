...
def get_results_dir(agent_name: str, model_name: str, experiment: str):
    ...
    Args:
        ...
        experiment: Experiment name used as the result subdirectory.

    Returns:
        Path: Results directory (created if doesn't exist)

    Example:
        >>> get_results_dir("miniswe-agent", "gpt-5-mini", "fault-localization")
        Path('.../results/miniswe-agent/gpt-5-mini/fault-localization')
    """
    results_dir = RESULTS_ROOT / agent_name / model_name / experiment
